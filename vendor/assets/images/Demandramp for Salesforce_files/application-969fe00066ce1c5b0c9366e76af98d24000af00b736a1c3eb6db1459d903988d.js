...
$(document).ready(metrics);
$(document).on('page:load', metrics);
...
openSidebar = function() {
  $('#open_sb').click(function() {
    $('#side-bar').toggleClass("showMe");
  })
};
$(document).ready(openSidebar);
$(document).on('page:load', openSidebar);
// DATEPICKER
$(function(){
  $("#date-picker").hide();

  var date_range = $("input[type='radio'][name='date_range']:checked").val();

  $("input[type='radio'][name='date_range']").change(function() {
    date_range = $(this).val();

    if ($(this).val() === 'Custom') {
      $("#date-picker").show(300);
    } else {
      $("#date-picker").hide(300);
    }
    ...
    $('#dp4').fdatepicker()
      .on('changeDate', function (ev) {
        ev.preventDefault();
        var today = new Date();
        var current_time = new Date(ev.date.getTime() + ev.date.getTimezoneOffset()*60000);
        ev.date = new Date(current_time)
      if (ev.date.valueOf() > endDate.valueOf()) {
        ...
        var el = document.getElementsByName('start_date')[0];
    ...
    $('#dp5').fdatepicker()
      ...
      if (ev.date.valueOf() < startDate.valueOf()) {
        ...
        $('#endDate').text(eDate);
        var el    = document.getElementsByName('end_date')[0];
        el.setAttribute('value', eDate);
      }
...
$(document).on('page:load', foundation);
