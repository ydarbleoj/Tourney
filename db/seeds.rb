joel = User.create!(first_name: 'Joel', last_name: 'Brady', username: 'Joel Brady', handicap: 7.6, email: 'brady.joel@gmail.com', password: 'gonzaga2004', password_confirmation: 'gonzaga2004', admin: true)
bryan = User.create!(first_name: 'Bryan', last_name: 'Hellum', username: 'Bryan Hellum', handicap: 8, email: 'bhellum@gmail.com', password: 'hellum1234', password_confirmation: 'hellum1234')
payne = User.create!(first_name: 'Mike', last_name: 'Payne', username: 'Mike Payne', handicap: 14, email: 'michaeljamespayne@yahoo.com', password: 'payne1234', password_confirmation: 'payne1234')
cory = User.create!(first_name: 'Cory', last_name: 'Booth', username: 'Cory Booth', handicap: 21, email: 'coryjbooth@gmail.com', password: 'booth1234', password_confirmation: 'booth1234')
jack = User.create!(first_name: 'Jack', last_name: 'Weast', username: 'Jack Weast', handicap: 25, email: 'jack.weast@intel.com', password: 'weast1234', password_confirmation: 'weast1234')
damon = User.create!(first_name: 'Damon', last_name: 'Sullivan', username: 'Damon Sullivan', handicap: 36, email: 'damon.sullivan@thugdesign.com', password: 'sullivan1234', password_confirmation: 'sullivan1234')
pat = User.create!(first_name: 'Pat', last_name: 'Anderson', username: 'Pat Anderson', handicap: 36, email: 'patrick.edward.anderson@gmail.com', password: 'anderson1234', password_confirmation: 'anderson1234')
robb = User.create!(first_name: 'Robb', last_name: 'Page', username: 'Robb Page', handicap: 6.5, email: 'theswine19@gmail.com', password: 'page1234', password_confirmation: 'page1234')
scott = User.create!(first_name: 'Scott', last_name: 'Kovesdy', username: 'Scott Kovesdy', handicap: 5.6, email: 'skovesdy@msn.com', password: 'kovesdy1234', password_confirmation: 'kovesdy1234')
rory = User.create!(first_name: 'Rory', last_name: 'Tarquinio', username: 'Rory Tarquinio', handicap: 24.6, email: 'rtarquinio10@gmail.com', password: 'tarquinio1234', password_confirmation: 'tarquinio1234')
albino = User.create!(first_name: 'Bino', last_name: 'Duran', username: 'Albino Duran', handicap: 14, email: 'albino.duran@verizon.com', password: 'duran1234', password_confirmation: 'duran1234')
greg = User.create!(first_name: 'Greg', last_name: 'Smith', username: 'Greg Smith', handicap: 23, email: 'grs@yurik.net', password: 'smith1234', password_confirmation: 'smith1234')
rich = User.create!(first_name: 'Rich', last_name: 'Guisti', username: 'Rich Guisti', handicap: 12.0, email: 'rich.giusti@masergy.com', password: 'guisti1234', password_confirmation: 'guisti1234')
dan = User.create!(first_name: 'Dan', last_name: 'Jablonski', username: 'Dan Jablonski', handicap: 18, email: 'daniel.jablonski@verizon.com', password: 'jablonski1234', password_confirmation: 'jablonski1234')
eric = User.create!(first_name: 'Eric', last_name: 'Fox', username: 'Eric Fox', handicap: 28.2, email: 'theazfoxes@mac.com', password: 'fox12345', password_confirmation: 'fox12345')
matt = User.create!(first_name: 'Matt', last_name: 'James', username: 'Matt James', handicap: 8.2, email: 'mjiggity@gmail.com', password: 'james1234', password_confirmation: 'james1234')
jeremy = User.create!(first_name: 'Jeremy', last_name: 'Emerson', username: 'Jeremy Emerson', handicap: 14, email: 'jeremy@wrightstrategies.com', password: 'emerson1234', password_confirmation: 'emerson1234')
david = User.create!(first_name: 'David', last_name: 'Sanda', username: 'David Sanda', handicap: 21.8, email: 'david.sanda@verizon.com', password: 'sanda1234', password_confirmation: 'sanda1234')
...
# bandon_2016 = Tournament.create!(name: 'Bandon', year: 2016, num_players: 16, num_rounds: 3, start_date: DateTime.new(2016, 3, 17, 18, 00, 00),
...
# # # First
# payne_rnd1 = payne.rounds.create!(tournament_id: bandon_2015.id, round_num: 1, course_id: 3,
